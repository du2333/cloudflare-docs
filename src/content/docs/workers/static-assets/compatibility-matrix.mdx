...
| [Custom HTTP headers for static assets](/pages/configuration/headers/)                                      | ✅      | ✅      |
...
| **Pages Functions**                                                                                         |         |         |
| [File-based Routing](/pages/functions/routing/)                                                             | ❌ [^3] | ✅      |
| [Pages Plugins](/pages/functions/plugins/)                                                                  | ❌ [^4] | ✅      |
...
[^3]: Workers [supports popular frameworks](/workers/frameworks/), many of which implement file-based routing.

[^4]: Everything that is possible with Pages Functions can also be achieved by adding code to your Worker or by using framework-specific plugins for relevant third party tools.
